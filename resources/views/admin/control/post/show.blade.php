...
@section('content')
    ...
    <div class="animated fadeIn">
        <form action="{{ route('posts.update', $post->id) }}" method="post" enctype="multipart/form-data" class="form mt-4">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-header">
                    Editando &mdash; {{ $post->title }}
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset($post->thumb_path) }}" width="200" class="mt-2">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
