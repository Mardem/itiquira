!function () {
    ...
    function S(t) {
        var e = new D(t), n = new O(e);
        e.harvestScriptsInDocument(), new j(e, {
            blocking: !0, docWriteSimulator: n, callback: function () {
            }
        }).run()
    }
    ...
    function w(t) {
        ...
        var r = new j(e, {
            blocking: !1, docWriteSimulator: n, callback: function () {
    ...
    var P = "http://www.w3.org/2000/svg", E = {
            ...
            "text/x-javascript": !0,
            module: !0
        }, A = void 0 !== document.createElement("script").noModule, k = function () {
            var t = window;
            return t.__rocketLoaderEventCtor || Object.defineProperty(t, "__rocketLoaderEventCtor", {value: Event}), t.__rocketLoaderEventCtor
        }(), I = document.write, L = document.writeln,
        _ = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            ...
            var t = window;
            return t.__rocketLoaderLoadProgressSimulator || Object.defineProperty(t, "__rocketLoaderLoadProgressSimulator", {value: new C}), t.__rocketLoaderLoadProgressSimulator
        }(), j = function () {
            function t(t, e) {
            ...
            return t.prototype.insertPreloadHints = function () {
                ...
                this.scriptStack.forEach(function (e) {
                    var n = i(e), r = h() && e.hasAttribute("integrity");
                    if (n && !r) {
    ...
    !function () {
        ...
        if (t) {
            var n = y(t);
            n ? (o(t), b(n), M.updateInlineHandlers(), n.bailout ? S(n.nonce) : (g(), w(n.nonce))) : e("Activator script doesn't have settings. No scripts will be executed.")
