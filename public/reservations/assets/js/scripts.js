...
jQuery(document).ready(function($) {
	...
	var WEATHER_API_KEY = '64ba97f3381e420c9c401c20bc7a5dc4';
	...
	var WEATHER_LOCATION_ID = '257224';
	var WEATHER_UNIT = 'C';
	...
	$( ".datepicker[name='check_in']" ).datepicker({
		showOn: 'both',
		...
		onSelect: function(dateText, dateObj){
			...
			$( ".datepicker[name='check_out']" ).datepicker("option", "minDate", minDate );
		}
	});

	$( ".datepicker[name='check_out']" ).datepicker({
		showOn: 'both',
		buttonText: '<i class="fa fa-calendar"></i>',
        locale: 'pt-BR',
        dateFormat: 'dd/mm/yy',
		onSelect: function(dateText, dateObj) {
			...
			$( ".datepicker[name='check_in']" ).datepicker("option", "maxDate", maxDate );
		}
	});
